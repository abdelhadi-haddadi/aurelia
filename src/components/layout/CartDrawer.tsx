  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden={!isCartOpen}
        className={`fixed top-0 right-0 bottom-0 w-full max-w-md bg-background border-l border-border z-[110] flex flex-col transition-transform duration-300 ease-out ${
            ...
            <div className="h-full flex flex-col items-center justify-center text-center gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground font-light">
                  Explore our collection to find your next masterpiece.
                </p>
              </div>
              <Button
                onClick={() => setIsCartOpen(false)}
                ...
                <div key={`${item.id}-${item.variant || idx}`} className="flex gap-6">
                  ...
                  <div className="flex flex-col justify-between py-1 flex-grow">
                    <div>
                      ...
                      {item.variant && (
                        <p className="text-[10px] text-primary/60 font-medium uppercase tracking-tighter mt-0.5">
                          {item.variant}
                        </p>
                      )}
                      <p className="text-[10px] text-muted-foreground font-light mt-1 uppercase tracking-tighter">
                        Qty: {item.quantity}
                      </p>
                    </div>
