  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50">
      ...
      <div className="absolute inset-x-0 bottom-0 h-[1px] overflow-hidden">
        <div className="aurora-border-slide-h h-full opacity-30" />
      </div>
      <div className="relative max-w-7xl mx-auto px-6 h-24 flex items-center justify-between gap-4">
        <div
          style={{ animation: 'navSlideLeft 0.8s ease both' }}
        ...
        <div
          style={{ animation: 'navSlideDown 0.8s ease both' }}
        ...
        <div
          style={{ animation: 'navSlideRight 0.8s ease both' }}
      ...
      {/* Side Menu — CSS transitions, no motion/react dependency */}
      {/* Backdrop */}
      <div
      ...
      <div
        ...
        aria-hidden={!isMenuOpen}
        className={`fixed top-0 left-0 bottom-0 w-full max-w-sm bg-background border-r border-border z-[70] p-12 flex flex-col transition-transform duration-300 ease-out ${
      ...
      >
        ...
        <div className="flex flex-col gap-8 flex-grow">
          {[
            ...
            <div
              key={item.label}
              className="hover:translate-x-2.5 transition-transform duration-200"
            >
              <Link
                to={item.path}
                onClick={() => setIsMenuOpen(false)}
